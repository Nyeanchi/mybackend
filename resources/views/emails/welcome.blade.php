...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            @if ($user->role === 'tenant' && isset($password))
                <div class="login-details">
                    <h3>Your Login Details</h3>
                    <p><strong>Email:</strong> {{ $user->email }}</p>
                    <p><strong>Temporary Password:</strong> {{ $password }}</p>
                    <p>Please use this temporary password to log in and change it in your account settings.</p>
                    <p><strong>Dashboard:</strong> <a href="{{ config('app.url') }}/login?role=tenant">Log in to your tenant dashboard</a></p>
                </div>
            @endif
            <div class="role-instructions">
                @if ($user->role === 'landlord')
                    <h3>Getting Started as a Landlord</h3>
                    <p>You can now list and manage your properties, track payments, and respond to maintenance requests.</p>
                    <ul>
